...
import com.example.zencom.zencom_shop.modules.catalog.application.usecases.product.all.ListAllActiveProductsUseCaseImpl;
...
class ListAllActiveProductsUseCaseTest {
    ...
    private ListAllActiveProductsUseCaseImpl listAllActiveProductsUseCase;
    private ProductRepository productRepository;

    @BeforeEach
    void setUp() {
        productRepository = mock(ProductRepository.class);
        listAllActiveProductsUseCase = new ListAllActiveProductsUseCaseImpl(productRepository);
    }
