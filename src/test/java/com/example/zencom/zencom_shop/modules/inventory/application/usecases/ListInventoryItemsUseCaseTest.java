...
import com.example.zencom.zencom_shop.modules.catalog.application.usecases.inventory.ListInventoryItemsUseCaseImpl;
...
class ListInventoryItemsUseCaseTest {
    ListInventoryItemsUseCaseImpl listInventoryItemsUseCase;
    InventoryItemRepository inventoryItemRepository;

    @BeforeEach
    void setUp() {
        inventoryItemRepository = mock(InventoryItemRepository.class);
        listInventoryItemsUseCase = new ListInventoryItemsUseCaseImpl(inventoryItemRepository);
    }
