...
import com.example.zencom.zencom_shop.modules.catalog.application.usecases.product.all.ListAllProductsUseCaseImpl;
...
class ListAllProductsUseCaseTest {
    ...
    void setUp() {
        ...
        listAllProductsUseCase = new ListAllProductsUseCaseImpl(productRepository);
    }
    @Test
